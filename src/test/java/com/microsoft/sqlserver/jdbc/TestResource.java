...
public final class TestResource extends ListResourceBundle {
    ...
    static final Object[][] contents = {
            {"R_wrongEnv", "Aborting test: As this is not the right environement: "},
            ...
            {"R_invalidEncrypt", "Invalid encrypt value."},
            ...
            {"R_expectedFailPassed", "Expected failure did not fail"},
            {"R_dataTypeNotFound", "Cannot find data type"},
            {"R_illegalCharWkt", "Illegal character at wkt position "},
            ...
            {"R_createDropTableFailed", "Create/drop table with preparedStatement failed!"},
            ...
            {"R_failedValidate", "failed to validate values in $0} "},
            {"R_tableNotDropped", "table not dropped. "},
            {"R_connectionReset", "Connection reset"},
            {"R_unknownException", "Unknown exception"},
            ...
            {"R_errorNotCalled", "Error occurred is not called."},
            {"R_errorCalled", "Error occurred is called."},
            ...
            {"R_noExceptionClosedConnection", "No exception thrown calling getClientConnectionId on a closed connection"},
            ...
            {"R_cannotOpenDatabase", "Cannot open database"},
            {"R_shouldNotConnect", "Should not have connected"},
            {"R_loginFailed", "Login failed"},
            {"R_exitedMoreSeconds", "Exited in more than {0} seconds."},
            ...
            {"R_invalidProtocolLabel", "SSL Protocol {0} label is not valid. Only TLS, TLSv1, TLSv1.1, and TLSv1.2 are supported."},
            ...
            {"R_readTimedOut", "Read timed out"},
            {"R_unexpectedErrorMessage", "Unexpected error message occured!"},
            {"R_warningsNotFound", "Warnings not found!"},
            {"R_warningsFound", "Warnings found!"},
            ...
            {"R_dbNameIsCurrentDB", "The database name component of the object qualifier must be the name of the current database."},
            ...
            {"R_buildVersionError", "build version should be greater than driver versions for non SNAPSHOT versions, and same for SNAPSHOT versions"},
            ...
            {"R_nameEmpty", "{0} name should not be empty."},
            {"R_nameNull", "{0} name should not be NULL."},
            ...
            {"R_Incompat_SQLServerVersion", "Aborting test case as SQL Server version is not compatible with Always encrypted"},
            ...
            {"R_SQLStateNull", "SQLState should not be null"},
            {"R_blobFreed", "This Blob oject has been freed."},
            {"R_streamNull", "Stream is null when data is not."},
            {"R_incorrectUpdateCount", "Incorrect updateCount."},
            ...
            {"R_unexpectedException", "Unexpected exception occurred"},
            {"R_addBatchFailed", "addBatch failed"},
            ...
            {"R_valueNotMatch", "Value does not match: "},
            {"R_incorrectDefault", "Incorrect default"},
            ...
            {"R_invalidGetPreparedStatementHandle", "Invalid use of getPreparedStatementHandle() after statement close expected."},
            {"R_cancellationFailed", "Cancellation failed."},
            {"R_executionNotTimeout", "Execution did not timeout."},
