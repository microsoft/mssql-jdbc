...
public final class TestResource extends ListResourceBundle {
    ...
    static final Object[][] contents = {{"R_wrongEnv", "Aborting test: As this is not the right environement: "},
            ...
            {"R_invalidCertFields", "Error reading certificate, please verify the location of the certificate.signed fields invalid"},
            {"R_invalidAADPasswordAuth", "Failed to authenticate the user {0} in Active Directory (Authentication=ActiveDirectoryPassword)"},
