...
//                + "     WHERE SalesYTD > 2500000.00);  ", "Sales . SalesPersonQuotaHistory,Sales . SalesPerson"));
        ...
        valuePair.add(Pair.of("DELETE TOP (20)   \r\n" + "FROM Purchasing.PurchaseOrderDetail  \r\n"
                + "WHERE DueDate < '20020701';", "Purchasing . PurchaseOrderDetail"));
        valuePair.add(Pair.of(
        ...
        valuePair.add(Pair.of("DELETE Production.ProductProductPhoto  \r\n" + "OUTPUT DELETED.ProductID,  \r\n"
                ...
                "Production . ProductProductPhoto AS ph JOIN Production . Product as p ON ph . ProductID = p . ProductID"));
