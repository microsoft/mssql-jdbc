...
public class LexerTest extends AbstractTest {
    ...
    public void testCTE() {
        ...
        valuePair.add(Pair.of("-- Define the CTE expression name and column list.  \r\n"
        ...
        valuePair.add(Pair.of("WITH Sales_CTE (SalesPersonID, NumberOfOrders)  \r\n" + "AS  \r\n" + "(  \r\n"
        ...
        valuePair.add(Pair.of("WITH Sales_CTE (SalesPersonID, TotalSales, SalesYear)  \r\n" + "AS  \r\n"
        ...
        valuePair.add(Pair.of("WITH DirectReports(ManagerID, EmployeeID, Title, EmployeeLevel) AS   \r\n" + "(  \r\n"
        ...
        valuePair.add(Pair.of("-- Create the recursive CTE to find all of Bonnie's ancestors.  \r\n"
        ...
        valuePair.add(Pair.of("WITH vw AS  \r\n" + " (  \r\n" + "    SELECT itmIDComp, itmID  \r\n"
                + "    FROM @t1  \r\n" + "  \r\n" + "    UNION ALL  \r\n" + "  \r\n"
                + "    SELECT itmIDComp, itmID  \r\n" + "    FROM @t2  \r\n" + ")   \r\n" + ",r AS  \r\n" + " (  \r\n"
