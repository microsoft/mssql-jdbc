...
public class UpdateTest extends AbstractTest {
    ...
    public void updateExamplesTest() {
        ...
        valuePair.add(
                Pair.of("UPDATE Production.Location \r\n" + "SET CostRate = DEFAULT \r\n" + "WHERE CostRate > 20.00; ",
                        "Production . Location"));
        ...
        valuePair.add(Pair.of("UPDATE Production.Document  \r\n"
        ...
        valuePair.add(Pair.of("UPDATE TOP (10) HumanResources.Employee  \r\n"
        ...
        valuePair.add(Pair.of("UPDATE HumanResources.Employee  \r\n" + "SET VacationHours =   \r\n" + "    ( CASE  \r\n"
                + "         WHEN SalariedFlag = 0 THEN VacationHours + @NewHours  \r\n"
                + "         ELSE @NewHours  \r\n" + "       END  \r\n" + "    )  \r\n" + "WHERE CurrentFlag = 1;",
                "HumanResources . Employee"));

        // AC. Using UPDATE in a TRY...CATCH Block
        valuePair.add(Pair.of("BEGIN TRY  \r\n" + "    -- Intentionally generate a constraint violation error.  \r\n"
                + "    UPDATE HumanResources.Department  \r\n" + "    SET Name = N'MyNewName'  \r\n"
                + "    WHERE DepartmentID BETWEEN 1 AND 2;  \r\n" + "END TRY", "HumanResources . Department"));

        // AD. Using a simple UPDATE statement
        valuePair.add(Pair.of("UPDATE DimEmployee  \r\n" + "SET EndDate = '2010-12-31', CurrentFlag='False';",
                "DimEmployee"));
