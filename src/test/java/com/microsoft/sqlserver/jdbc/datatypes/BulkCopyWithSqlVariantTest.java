...
public class BulkCopyWithSqlVariantTest extends AbstractTest {
    ...
    public void bulkCopyTestInt() throws SQLException {
        try (Connection con = DriverManager.getConnection(connectionString)) {
            ...
            try (Statement stmt = con.createStatement()) {
                ...
                try (ResultSet rs = stmt.executeQuery("SELECT * FROM " + AbstractSQLGenerator.escapeIdentifier(destTableName))) {
                    while (rs.next()) {
    ...
    public void bulkCopyTestMoney() throws SQLException {
        try (Connection con = DriverManager.getConnection(connectionString)) {
            ...
            try (Statement stmt = con.createStatement()) {
                ...
                try (SQLServerResultSet rs = (SQLServerResultSet) stmt.executeQuery("SELECT * FROM " + AbstractSQLGenerator.escapeIdentifier(destTableName))) {
                    while (rs.next()) {
    ...
    public void bulkCopyTestSmallmoney() throws SQLException {
        try (Connection con = DriverManager.getConnection(connectionString); Statement stmt = con.createStatement()) {
            ...
            stmt.executeUpdate(
                    "INSERT into " + AbstractSQLGenerator.escapeIdentifier(tableName) + "(col1) values (CAST (" + col1Value + " AS " + "smallmoney" + ") )");
    ...
    public void bulkCopyTestTwoCols() throws SQLException {
        try (Connection con = DriverManager.getConnection(connectionString); Statement stmt = con.createStatement()) {
            ...
            stmt.executeUpdate("create table " + AbstractSQLGenerator.escapeIdentifier(destTableName) + " (col1 sql_variant, col2 sql_variant)");
    ...
    public void bulkCopyTestTime() throws SQLException {
        try (Connection con = DriverManager.getConnection(connectionString); Statement stmt = con.createStatement()) {
            ...
            stmt.executeUpdate("create table " + AbstractSQLGenerator.escapeIdentifier(tableName) + " (col1 sql_variant)");
            stmt.executeUpdate(
                    "INSERT into " + AbstractSQLGenerator.escapeIdentifier(tableName) + "(col1) values (CAST (" + col1Value + " AS " + "time(2)" + ") )");
            stmt.executeUpdate("create table " + AbstractSQLGenerator.escapeIdentifier(destTableName) + " (col1 sql_variant)");
    ...
    private void beforeEachSetup(String colType, Object colValue) throws SQLException {
        try (Connection con = DriverManager.getConnection(connectionString); Statement stmt = con.createStatement()) {
            ...
            stmt.executeUpdate("create table " + AbstractSQLGenerator.escapeIdentifier(tableName) + " (col1 sql_variant)");
            stmt.executeUpdate(
                    "INSERT into " + AbstractSQLGenerator.escapeIdentifier(tableName) + "(col1) values (CAST (" + colValue + " AS " + colType + ") )");
            stmt.executeUpdate("create table " + AbstractSQLGenerator.escapeIdentifier(destTableName) + " (col1 sql_variant)");
        }
    }
