...
public class BulkCopyConnectionTest extends BulkCopyTestSetUp {
    ...
    List<BulkCopyTestWrapper> createTestDatatestBulkCopyConstructor() {
        ...
        bulkWrapper1.setUsingXAConnection(true, dsPool);
        ...
        bulkWrapper2.setUsingXAConnection(false, dsPool);
        ...
        bulkWrapper3.setUsingXAConnection(false, dsPool);
        ...
        bulkWrapper4.setUsingXAConnection(true, dsPool);
        ...
        for (Method method : methods) {
            ...
            if (0 != method.getParameterTypes().length && boolean.class == method.getParameterTypes()[0]) {
                try {
                    ...
                    bulkWrapper.setUsingConnection((0 == ThreadLocalRandom.current().nextInt(2)) ? true : false, ds);
                    bulkWrapper.setUsingXAConnection((0 == ThreadLocalRandom.current().nextInt(2)) ? true : false,
                            dsXA);
                    bulkWrapper.setUsingPooledConnection((0 == ThreadLocalRandom.current().nextInt(2)) ? true : false,
                            dsPool);
