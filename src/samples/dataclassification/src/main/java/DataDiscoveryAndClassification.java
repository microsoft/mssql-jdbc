 ...
 */
package dataclassification.src.main.java;
...
/**
 * Sample test for 'SQL Data Discovery and Classification' feature
 * 
...
public class DataDiscoveryAndClassification {
    ...
    public static void main(String[] args) {
        ...
        try (InputStreamReader in = new InputStreamReader(System.in); BufferedReader br = new BufferedReader(in)) {
            System.out
                    .println("Provide server credentials that supports 'SQL Discovery and Classification' feature.\n");
