...
public final class Weighers {
    ...
    /**
     * A weigher where an entry has a weight of <tt>1</tt>. A map bounded with this weigher will evict when the number
     * of key-value pairs exceeds the capacity.
     *
     * @param <K>
     *        K
     * @param <V>
    ...
    /**
     * A weigher where a value has a weight of <tt>1</tt>. A map bounded with this weigher will evict when the number of
     * key-value pairs exceeds the capacity.
     *
     * @param <V>
     *        V
     * @return A weigher where a value takes one unit of capacity.
     ...
     * <p>
     * A value with a weight of <tt>0</tt> will be rejected by the map. If a value with this weight can occur then the
     * caller should eagerly evaluate the value and treat it as a removal operation. Alternatively, a custom weigher may
     * be specified on the map to assign an empty value a positive weight.
     *
