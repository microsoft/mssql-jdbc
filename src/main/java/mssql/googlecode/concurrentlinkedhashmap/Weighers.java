...
public final class Weighers {
    ...
    /**
     * A weigher where an entry has a weight of <code>1</code>. A map bounded with this weigher will evict when the
     * number of key-value pairs exceeds the capacity.
     *
     * @param <K>
     *        K
     * @param <V>
    ...
    /**
     * A weigher where a value has a weight of <code>1</code>. A map bounded with this weigher will evict when the
     * number of key-value pairs exceeds the capacity.
     *
     * @param <V>
     *        V
    ...
    /**
     * A weigher where the value is a byte array and its weight is the number of bytes. A map bounded with this weigher
     * will evict when the number of bytes exceeds the capacity rather than the number of key-value pairs in the map.
     * This allows for restricting the capacity based on the memory-consumption and is primarily for usage by dedicated
     * caching servers that hold the serialized data.
     * <p>
     * A value with a weight of <code>0</code> will be rejected by the map. If a value with this weight can occur then
     * the caller should eagerly evaluate the value and treat it as a removal operation. Alternatively, a custom weigher
    ...
    /**
     * A weigher where the value is a {@link Iterable} and its weight is the number of elements. This weigher only
    ...
    /**
     * A weigher where the value is a {@link Collection} and its weight is the number of elements. A map bounded with
    ...
    /**
     * A weigher where the value is a {@link List} and its weight is the number of elements. A map bounded with this
     * weigher will evict when the total number of elements exceeds the capacity rather than the number of key-value
     * pairs in the map.
     * <p>
     * A value with a weight of <code>0</code> will be rejected by the map. If a value with this weight can occur then
     * the caller should eagerly evaluate the value and treat it as a removal operation. Alternatively, a custom weigher
    ...
    /**
     * A weigher where the value is a {@link Set} and its weight is the number of elements. A map bounded with this
     * weigher will evict when the total number of elements exceeds the capacity rather than the number of key-value
     * pairs in the map.
     * <p>
     * A value with a weight of <code>0</code> will be rejected by the map. If a value with this weight can occur then
    ...
    /**
     * A weigher where the value is a {@link Map} and its weight is the number of entries. A map bounded with this
