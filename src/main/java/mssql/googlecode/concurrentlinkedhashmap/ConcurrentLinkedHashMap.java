 ...
 * <p>
 * An entry is evicted from the map when the <b>weighted capacity</b> exceeds
 * its <b>maximum weighted capacity</b> threshold. A {@link EntryWeigher}
 * determines how many units of capacity that an entry consumes. The default
 * weigher assigns each value a weight of <b>1</b> to bound the map by the
 ...
 * <p>
 * The <b>concurrency level</b> determines the number of threads that can
...
public final class ConcurrentLinkedHashMap<K, V> extends AbstractMap<K, V>
  ...
  public static final class Builder<K, V> {
    ...
    /**
     * Specifies the initial capacity of the hash table (default <b>16</b>).
     ...
     * key-value pairs by giving each entry a weight of <b>1</b>.
     *
