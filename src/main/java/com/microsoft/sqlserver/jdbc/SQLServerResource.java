...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] contents = {
            ...
            {"R_ntlmUnknownServer", "Unable to initialize NTLM authentication: Unknown server name \"{0}\""},
            ...
            {"R_ntlmBadDomain", "NTLM Challenge Message error: bad domain name \"{0}\", expecting \"{1}\""},
