...
public final class SQLServerResource extends ListResourceBundle {
	...
	static final Object[][] CONTENTS = {
			...
			{ "R_invalidValueForTVPWithSQLVariant",
					"Use of TVPs containing null sql_variant columns is not supported." },
			...
			{ "R_keyVaultProviderRegistrationModePropertyDescription",
					"The registration mode used to register the Azure Key Vault provider." },
			{ "R_keyVaultManagedIdentityClientIdPropertyDescription",
					"Client Id of User Assigned Managed Identity to be used for generating access token for Azure Key Vault." },
