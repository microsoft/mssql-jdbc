...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] CONTENTS =
    {
        ...
        {"R_NoUserPasswordForActiveServicePrincipal", "Both \"UserName\" and \"Password\" connection string keywords must be specified, if \"Authentication=ActiveDirectoryServicePrincipal or ActiveDirectoryServicePrincipalCertificate\"."},
