...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] CONTENTS =
    {
        ...
        {"R_InvalidIPAddressPreference", "Invalid option for connection string option IPAddressPreference, the available options are: IPv4First, IPv6First and UsePlatformDefault"},
