...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] CONTENTS =
    {
        ...
        {"R_otelArmResourceIdPropertyDescription", "Optional ARM resource id of the target resource. When set, the driver sends it as the x-ms-arm-resource-id header on every OTLP/HTTP export so the collector can perform a CheckAccess (RBAC) authorization for callers whose token has no resource identity. Default empty (not sent)."},
