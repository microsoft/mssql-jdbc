...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] CONTENTS =
    {
        ...
        {"R_otelProfilePropertyDescription", "The OpenTelemetry configuration profile to apply for telemetry export."},
        {"R_otelAuthPropertyDescription", "The authentication mechanism used to acquire a token for the OpenTelemetry telemetry endpoint."},
        {"R_otelEndpointPropertyDescription", "The bring-your-own OpenTelemetry (OTLP) endpoint to export telemetry to."},
        {"R_otelAccessTokenCallbackClassPropertyDescription", "The class to instantiate as the SQLServerAccessTokenCallback for acquiring OpenTelemetry telemetry tokens."},
        ...
        {"R_ClientOpenTelemetryFeatureAckInvalid", "The Client OpenTelemetry feature extension acknowledgement is malformed or truncated."},
