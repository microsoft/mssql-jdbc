...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] CONTENTS = {
            ...
            {"R_MSALExecution", "Failed to authenticate the user {0} in Active Directory (Authentication={1}). {2}"},
            {"R_MSALServiceException",
                    "Secure token service (STS) returned an error response or another networking error occurred"},
            {"R_MSALThrottlingException", "Request was throttled according to instructions from STS"},
            {"R_MSALAuthComplete", "Authentication complete. You can close the browser and return to the application."},
            {"R_MSALClientErrorcode", "Client Error code: {0}."},
            {"R_MSALServiceStatus", "Service error status: {0}."},
            {"R_MSALException", "Unknown MSAL error"},
