...
enum SQLServerDriverStringProperty {
    ...
    ENCLAVE_ATTESTATIONURL("enclaveAttestationUrl", ""),
...
public final class SQLServerDriver implements java.sql.Driver {
    ...
    private static final SQLServerDriverPropertyInfo[] DRIVER_PROPERTIES = {
            ...
            new SQLServerDriverPropertyInfo(SQLServerDriverStringProperty.ENCLAVE_ATTESTATIONURL.toString(),
                    SQLServerDriverStringProperty.ENCLAVE_ATTESTATIONURL.getDefaultValue(), false, null),
