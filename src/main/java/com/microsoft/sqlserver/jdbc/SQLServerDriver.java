...
enum SQLServerDriverBooleanProperty {
    ...
    BULK_COPY_OPTION_DEFAULTS_CHECK_CONSTRAINTS("bulkCopyOptionDefaultsCheckConstraints", false),
    BULK_COPY_OPTION_DEFAULTS_FIRE_TRIGGERS("bulkCopyOptionDefaultsFireTriggers", false),
    BULK_COPY_OPTION_DEFAULTS_KEEP_IDENTITY("bulkCopyOptionDefaultsKeepIdentity", false),
    BULK_COPY_OPTION_DEFAULTS_KEEP_NULLS("bulkCopyOptionDefaultsKeepNulls", false),
    BULK_COPY_OPTION_DEFAULTS_TABLE_LOCK("bulkCopyOptionDefaultsTableLock", false),
    BULK_COPY_OPTION_DEFAULTS_USE_INTERNAL_TRANSACTION("bulkCopyOptionDefaultsUseInternalTransaction", false),
    BULK_COPY_OPTION_DEFAULTS_ALLOW_ENCRYPTED_VALUE_MODIFICATIONS("bulkCopyOptionDefaultsAllowEncryptedValueModifications", false),
...
public final class SQLServerDriver implements java.sql.Driver {
    ...
    private static final SQLServerDriverPropertyInfo[] DRIVER_PROPERTIES = {
            ...
            new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_CHECK_CONSTRAINTS.toString(),
                    Boolean.toString(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_CHECK_CONSTRAINTS.getDefaultValue()),false, TRUE_FALSE),
            new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_FIRE_TRIGGERS.toString(),
            		Boolean.toString(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_FIRE_TRIGGERS.getDefaultValue()),false, TRUE_FALSE),
            new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_KEEP_IDENTITY.toString(),
                    Boolean.toString(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_KEEP_IDENTITY.getDefaultValue()),false, TRUE_FALSE),
            new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_KEEP_NULLS.toString(),
                    Boolean.toString(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_KEEP_NULLS.getDefaultValue()),false, TRUE_FALSE),
            new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_TABLE_LOCK.toString(),
                    Boolean.toString(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_TABLE_LOCK.getDefaultValue()),false, TRUE_FALSE),
            new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_USE_INTERNAL_TRANSACTION.toString(),
                    Boolean.toString(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_USE_INTERNAL_TRANSACTION.getDefaultValue()),false, TRUE_FALSE),
            new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_ALLOW_ENCRYPTED_VALUE_MODIFICATIONS.toString(),
                    Boolean.toString(SQLServerDriverBooleanProperty.BULK_COPY_OPTION_DEFAULTS_ALLOW_ENCRYPTED_VALUE_MODIFICATIONS.getDefaultValue()),false, TRUE_FALSE),
