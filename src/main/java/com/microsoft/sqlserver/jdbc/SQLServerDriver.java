...
public final class SQLServerDriver implements java.sql.Driver {
    ...
    private static final SQLServerDriverPropertyInfo[] DRIVER_PROPERTIES = {
            ...
            new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.USE_PLATFORM_GSS_CREDENTIALS.toString(),
                    Boolean.toString(SQLServerDriverBooleanProperty.USE_PLATFORM_GSS_CREDENTIALS.getDefaultValue()),
                    false, TRUE_FALSE),
