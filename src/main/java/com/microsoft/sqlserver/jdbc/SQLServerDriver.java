...
enum SQLServerDriverBooleanProperty
{
    ...
    FIPS                               ("fips",                            false),
    PREPARE_STATEMENT_ON_FIRST_CALL    ("prepareStatementOnFirstCall",     false/*This is not the default, default handled in SQLServerConnection and is not final/const*/);
...
public final class SQLServerDriver implements java.sql.Driver {
    ...
    private static final SQLServerDriverPropertyInfo[] DRIVER_PROPERTIES =
    {
        ...
        new SQLServerDriverPropertyInfo(SQLServerDriverBooleanProperty.PREPARE_STATEMENT_ON_FIRST_CALL.toString(),         Boolean.toString(SQLServerConnection.getDefaultPrepareStatementOnFirstCall()),                          false,      TRUE_FALSE),
