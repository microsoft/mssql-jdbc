...
enum SSLProtocol {
	...
	TLS_ALL                               (Util.isIBM() ? "SSL_TLSv2" : "TLS")
    ;  
    ...
    static SSLProtocol valueOfString(String value) throws SQLServerException {
    	...
    	if(value.toLowerCase(Locale.ENGLISH).equalsIgnoreCase(SSLProtocol.TLS_V10.toString())) {
...
enum SQLServerDriverStringProperty
{
	...
	SSL_PROTOCOL               ("sslProtocol",             SSLProtocol.TLS_ALL.toString()),
	;
...
public final class SQLServerDriver implements java.sql.Driver {
    ...
    private static final SQLServerDriverPropertyInfo[] DRIVER_PROPERTIES =
    {
        ...
        new SQLServerDriverPropertyInfo(SQLServerDriverStringProperty.SSL_PROTOCOL.toString(),                                SQLServerDriverStringProperty.SSL_PROTOCOL.getDefaultValue(),                                           false,      new String[] {SSLProtocol.TLS_V10.toString(), SSLProtocol.TLS_V11.toString(), SSLProtocol.TLS_V12.toString()}),
    };
