...
public class SQLServerColumnEncryptionAzureKeyVaultProvider extends SQLServerColumnEncryptionKeyStoreProvider {
     ...
     * This is used by KeyVaultClient at runtime to authenticate to Azure Key Vault.
     * 
    ...
    /**
     * Constructs a SQLServerColumnEncryptionAzureKeyVaultProvider with a client id and client key to authenticate to AAD.
     * This is used by KeyVaultClient at runtime to authenticate to Azure Key Vault.
     * 
     * @param clientId
