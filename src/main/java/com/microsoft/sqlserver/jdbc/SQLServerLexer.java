...
class SQLServerLexer extends Lexer {
        ...
        static final int
                ...
                TIES=29, LIKE=30, IN=31, IS=32, NOT=33, BETWEEN=34, AND=35, SPACE=36, 
                COMMENT=37, LINE_COMMENT=38, DOUBLE_QUOTE=39, SINGLE_QUOTE=40, LOCAL_ID=41, 
                DECIMAL=42, ID=43, STRING=44, DOUBLE_LITERAL=45, SQUARE_LITERAL=46, BINARY=47, 
                FLOAT=48, REAL=49, EQUAL=50, GREATER=51, LESS=52, GREATER_EQUAL=53, LESS_EQUAL=54, 
                NOT_EQUAL=55, EXCLAMATION=56, PLUS_ASSIGN=57, MINUS_ASSIGN=58, MULT_ASSIGN=59, 
                DIV_ASSIGN=60, MOD_ASSIGN=61, AND_ASSIGN=62, XOR_ASSIGN=63, OR_ASSIGN=64, 
                DOUBLE_BAR=65, DOT=66, UNDERLINE=67, AT=68, SHARP=69, DOLLAR=70, LR_BRACKET=71, 
        ...
        private static String[] makeRuleNames() {
                return new String[] {
                        ...
                        "IN", "IS", "NOT", "BETWEEN", "AND", "SPACE", "COMMENT", "LINE_COMMENT", 
                        "DOUBLE_QUOTE", "SINGLE_QUOTE", "LOCAL_ID", "DECIMAL", "ID", "STRING", 
                        "DOUBLE_LITERAL", "SQUARE_LITERAL", "BINARY", "FLOAT", "REAL", "EQUAL", 
                        "GREATER", "LESS", "GREATER_EQUAL", "LESS_EQUAL", "NOT_EQUAL", "EXCLAMATION", 
