...
public class SQLServerStatement implements ISQLServerStatement {
     ...
     */
    final void executeStatement(TDSCommand newStmtCmd) throws SQLServerException, java.sql.SQLTimeoutException {
        ...
        try {
        	...
        	if (e.getDriverErrorCode() == SQLServerException.ERROR_QUERY_TIMEOUT)
        		throw new java.sql.SQLTimeoutException(e.getMessage());
        	else
        		throw e;
        }
        finally {
     ...
     */
    public java.sql.ResultSet executeQuery(String sql) throws SQLServerException, java.sql.SQLTimeoutException {
    ...
    final SQLServerResultSet executeQueryInternal(String sql) throws SQLServerException, java.sql.SQLTimeoutException {
        checkClosed();
     ...
     */
    public int executeUpdate(String sql) throws SQLServerException, java.sql.SQLTimeoutException {
     ...
     * @return The number of rows updated.
     */
    public long executeLargeUpdate(String sql) throws SQLServerException, java.sql.SQLTimeoutException {
     ...
     */
    public boolean execute(String sql) throws SQLServerException, java.sql.SQLTimeoutException {
     ...
     */
    public int[] executeBatch() throws SQLServerException, BatchUpdateException, java.sql.SQLTimeoutException {
    ...
    public long[] executeLargeBatch() throws SQLServerException, BatchUpdateException, java.sql.SQLTimeoutException {
        DriverJDBCVersion.checkSupportsJDBC42();
    ...
    public final boolean execute(java.lang.String sql,
            int autoGeneratedKeys) throws SQLServerException, java.sql.SQLTimeoutException {
        if (loggerExternal.isLoggable(java.util.logging.Level.FINER)) {
    ...
    public final boolean execute(java.lang.String sql,
            int[] columnIndexes) throws SQLServerException, java.sql.SQLTimeoutException {
        if (loggerExternal.isLoggable(java.util.logging.Level.FINER))
    ...
    public final boolean execute(java.lang.String sql,
            java.lang.String[] columnNames) throws SQLServerException, java.sql.SQLTimeoutException {
        if (loggerExternal.isLoggable(java.util.logging.Level.FINER))
    ...
    public final int executeUpdate(java.lang.String sql,
            String[] columnNames) throws SQLServerException, java.sql.SQLTimeoutException {
        if (loggerExternal.isLoggable(java.util.logging.Level.FINER))
