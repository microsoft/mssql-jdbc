...
public class SQLServerBulkCopy implements java.lang.AutoCloseable, java.io.Serializable {
        ...
        final class InsertBulk extends TDSCommand {
            ...
            final boolean doExecute() throws SQLServerException {
                ...
                if (timeoutSeconds > 0) {
                    ...
                    TDSCommand command = this;
                    SQLServerTimeoutManager.startTimeoutCommand(new Callable<Object>() {
                ...
                try {
                    ...
                    if (rootCause instanceof SQLException) {
                        boolean canTimeout = timeoutSeconds > 0
                                && ((System.currentTimeMillis() - startTime) / 1000) > timeoutSeconds;
                        checkForTimeoutException((SQLException) rootCause, canTimeout);
                    }
     ...
     */
    private void checkForTimeoutException(SQLException e, boolean canTimeout) throws SQLServerException {
