...
public interface ISQLServerPreparedStatement extends java.sql.PreparedStatement, ISQLServerStatement {
    ...
    /**
     * Sets the designated parameter to the given <code>microsoft.sql.Geometry</code> Class object. The driver converts this to an SQL
    ...
    /**
     * Sets the designated parameter to the given <code>microsoft.sql.Geography</code> Class object. The driver converts this to an SQL
     * <code>REAL</code> value when it sends it to the database.
     *
     * @param parameterIndex
     *            the first parameter is 1, the second is 2, ...
