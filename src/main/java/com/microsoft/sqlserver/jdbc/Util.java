...
final class Util {
     ...
     *         if the {@code CharSequence} does not contain a parsable {@code int} in the specified {@code radix}, or if
        ...
        if (i < endIndex) {
            ...
            if (firstChar < '0') { // Possible leading "+" or "-"
                if (firstChar == '-') {
                    ...
                    throw new NumberFormatException("Error at index " + (i - beginIndex) + " in: \""
            ...
            throw new NumberFormatException(
                    "For input string: \"" + "" + "\"" + (radix == 10 ? "" : " under radix " + radix));
        }
    }
}
