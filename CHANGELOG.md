...
### Fixed issues
- Revert #2051 (Big decimal precision) / #2116 (Fix for bigDecimal values between 0 and 1 having too high of a precision) [#2174](https://github.com/microsoft/mssql-jdbc/pull/2176)
