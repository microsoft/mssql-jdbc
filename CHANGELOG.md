...
### Fixed issues
- Fixed a potential NullPointerException issue when retrieving data as java.time.LocalTime or java.time.LocalDate type from SQLServerResultSet.getObject() [#1250](https://github.com/microsoft/mssql-jdbc/pull/1250)
