...
* Maven:
	...
	2. Run one of the commands below to build a JRE 11 and newer versions compatible jar or JRE 8 compatible jar in the `\target` directory. 
        * Run `mvn install -Pjre18`. This creates JRE 18 compatible jar in `\target` directory which is JDBC 4.3 compliant (Build with JDK 18+).
...
* Gradle:
	...
	2. Run one of the commands below to build a JRE 11 and newer versions compatible jar or JRE 8 compatible jar in the `\build\libs` directory. 
        * Run `gradle build -PbuildProfile=jre18`. This creates JRE 18 compatible jar in `\build\libs` directory which is JDBC 4.3 compliant (Build with JDK 18+).
